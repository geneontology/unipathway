 ...
 * [upa.yml](upa.yml)
     * Determines how your purl.obolibrary.org/obo/upa/ redirects will be handled
     ...
     * Paste in the contents of [upa.yml](upa.yml)
 ...
 * [upa.md](upa.md)
     ...
     * Paste in the contents of [upa.md](upa.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
