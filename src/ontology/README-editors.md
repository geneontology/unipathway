These notes are for the EDITORS of upa
...
Make sure you have an ID range in the [idranges file](upa-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [upa-edit.owl](upa-edit.owl)

** DO NOT EDIT upa.obo OR upa.owl in the top level directory **

[../../upa.owl](../../upa.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/geneontology/unipathway) for details.
 ...
 * [upa-idranges.owl](upa-idranges.owl)
...
This generates derived files such as upa.owl and upa.obo and places
 ...
 * https://github.com/geneontology/unipathway/releases
 * https://github.com/geneontology/unipathway/releases/new
...
what is in the `owl:versionIRI` of the derived upa.owl (`data-version` in
upa.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/upa.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/upa/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/geneontology/unipathway.svg?branch=master)](https://travis-ci.org/geneontology/unipathway)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/geneontology](https://travis-ci.org/profile/geneontology)
 2. click the "Sync account" button
 3. Click the tick symbol next to unipathway
